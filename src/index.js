...
var standardGet2 = path => {
  return params => {
    return axios
      .get(`https://ebird.org/ws2.0${path}`, {
        params: {
          ...defaultParams,
          ...params
        }
...
var ebird = {
  ...
  ref: {
    taxa: standardGet2("/ref/taxonomy/ebird"),
    ...
    location: params => {
      var func = params.match
        ? standardGet("/ref/location/find")
        : standardGet("/ref/location/list");
      return func(params);
    },
